...
def upgrade():
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('available', 'maintenance', 'unavailable', name='roomstatus'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('role', sa.Enum('guest', 'receptionist', 'admin', name='role'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['service_id'], ['extraservices.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
