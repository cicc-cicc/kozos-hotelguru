...
with app.app_context():
    ...
    resp = client.post('/auth/login', data={'username':'recepcios_kati','password':'rec123'}, follow_redirects=True)
    ...
    resp2 = client.post('/auth/login', data={'username':'admin_janos','password':'admin123'}, follow_redirects=True)
