...
def find_latest_dump(backup_dir):
    dumps = [
        f
...
def upsert_from_dump(path, app, db, models):
    ...
    ExtraService = models.get("ExtraService")
    BookingStatus = models.get("BookingStatus")
...
if __name__ == "__main__":
    ...
    models_map = {
        ...
        "ExtraService": _models.ExtraService,
    ...
    upsert_from_dump(dump, app, db, models_map)
    print("Done")
